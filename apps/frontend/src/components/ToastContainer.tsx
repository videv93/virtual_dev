...
import { Toast as ToastType } from '@virtual-dev/shared';
...
const Toast: React.FC<{ toast: ToastType }> = ({ toast }) => {
  ...
  const getToastStyles = () => {
    const baseStyles = 'px-4 py-3 rounded-lg shadow-lg flex items-center gap-2 min-w-[280px] max-w-md animate-slide-in';
